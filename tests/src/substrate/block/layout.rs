...
// BEGIN AUTOGENERATED
pub struct TransformedBufferData<'a> {
    pub inv1: Transformed<'a, Instance<Inverter>>,
    pub inv2: Transformed<'a, Instance<Inverter>>,
}

impl HasTransformedView for BufferData {
    type TransformedView<'a> = TransformedBufferData<'a>;
    ...
    fn transformed_view(
        ...
        Self::TransformedView {
            inv1: self.inv1.transformed_view(trans),
            inv2: self.inv2.transformed_view(trans),
        }
    }
}
// END AUTOGENERATED
...
// BEGIN AUTOGENERATED
pub struct TransformedBufferNData<'a> {
    pub buffers: Transformed<'a, [Instance<Buffer>]>,
}

impl HasTransformedView for BufferNData {
    type TransformedView<'a> = TransformedBufferNData<'a>;
    ...
    fn transformed_view(
        ...
        Self::TransformedView {
            buffers: self.buffers.transformed_view(trans),
        }
    }
}
// END AUTOGENERATED
