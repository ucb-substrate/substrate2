...
use crate::types::layout::{
    BundleBuilder, HierarchicalBuildFrom, PortGeometry, PortGeometryBuilder,
};
use std::fmt::Display;
...
impl<S: Schema> layout::BundleKind<S> for Signal {
...
impl<S: Schema, T: layout::BundleKind<S>> layout::BundleKind<S> for Array<T> {
